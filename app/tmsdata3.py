...
def run(logger):
    ...
    try:
        ...
        prefix = 'tmsdata3/'
        downloadFile = 'data/download/tmsdata3.csv'
        filterFile = 'tmsdata3.csv'
        datasourceName = 'finaltmsdata3'
            ...
            "spec": {
                "dataSchema": {
                    ...
                    "parser": {
                        ...
                        "dimensionsSpec": {
                            "dimensions": ["shop", "발송형태", "고유번호", "base_date"],
                            "dimensionExclusions": [],
                            "spatialDimensions": []
                        },
        ...
        logger.info('====== Finish - tmsdata3 =====')
    except:
        logger.exception("Got exception on tmsdata3")
